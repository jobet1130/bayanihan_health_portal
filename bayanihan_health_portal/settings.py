"""
Django settings for bayanihan_health_portal project.

Generated by 'djangocms' command using django CMS 5.0.2 and Django 5.2.
...
SECRET_KEY = "django-insecure-!j$n_ur%)dj-692!-@re8+9nqv%#%tms6am9@!aga@+2af=fom"
...
ROOT_URLCONF = "bayanihan_health_portal.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "bayanihan_health_portal", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "bayanihan_health_portal.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / "bayanihan_health_portal" / "static",
]
